# VSL — Nacionalidade portuguesa (gancho + miolo)

Montagem: Bloco 1 abaixo → Bloco 2 fixo → Bloco 3 abaixo → Blocos 4, 5 e 6
fixos (ver roteiro-mestre.md). Base jurídica: docs/pesquisa/portuguesa.md.
...
## Bloco 3 — [MIOLO-PORTUGUESA] (1:10-4:30)
...
> A via do neto continua existindo: quem tem avô ou avó português de origem
> pode pedir a nacionalidade. Mas a lei nova pendurou requisitos novos nessa
> porta: comprovar conhecimento da língua E da cultura, da história, dos
> símbolos portugueses. Declaração solene. Análise de idoneidade, com o
...
> sai, ele é português desde que nasceu. E você, automaticamente, vira filho
> de português: entra pela porta mais direta da lei.
> Funciona. Exige planejamento, porque são dois processos em sequência, e a
> fila portuguesa é longa: são centenas de milhares de pedidos esperando.
> Cada ano que a família adia é um ano a mais nessa conta.

> Um aviso sobre o avô que virou brasileiro: até 1981, quem se naturalizava
> perdia a nacionalidade portuguesa. Se essa é a história da sua família, o
...
*(Rubrica: nos "resumindo o mapa", ritmo mais lento, é o trecho que a pessoa
vai rebobinar. B-roll opcional: Diário da República na tela, assento antigo.)*
